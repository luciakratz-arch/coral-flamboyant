...
function Relatorios(_ref32) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    style: lbl
  }, "Resumo Executivo"), /*#__PURE__*/React.createElement("textarea", {
    style: _objectSpread(_objectSpread({}, ta), {}, {minHeight: 120}),
    placeholder: "Escreva aqui o resumo executivo do coral — conquistas, objetivos, contexto geral...",
    value: formTextos.resumoExecutivo || "",
    onChange: function onChange(e) {
...
function App() {
  var _useState207 = useState(function () {
    ...
    user = _useState208[0],
    setUser = _useState208[1];
  var _useState209 = useState([]),
    _useState210 = _slicedToArray(_useState209, 2),
    members = _useState210[0],
    setMembers = _useState210[1];
  var _useState211 = useState("painel"),
    _useState212 = _slicedToArray(_useState211, 2),
    tab = _useState212[0],
    setTab = _useState212[1];
